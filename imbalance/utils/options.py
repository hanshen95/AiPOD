...
def args_parser():
    ...
    parser.add_argument('--p', type=float, default=0.5, help='Probability to communicate in FedSkip.')
    ...
    parser.add_argument('--optim', type=str, default='svrg', help='inner optimizer name:IO')

    # other arguments
    parser.add_argument('--dataset', type=str, default='mnist', help="name of dataset")
    parser.add_argument('--iid', action='store_true', help='whether i.i.d dataset or not')
    parser.add_argument('--size', type=int, default=-1, help='how much data to use in dataset')
    parser.add_argument('--num_classes', type=int, default=10, help="number of classes")
    parser.add_argument('--num_channels', type=int, default=1, help="number of channels of imges")
    parser.add_argument('--gpu', type=int, default=0, help="GPU ID, -1 for CPU")
    parser.add_argument('--stopping_rounds', type=int, default=10, help='rounds of early stopping')
    parser.add_argument('--verbose', action='store_true', help='verbose print')
    parser.add_argument('--seed', type=int, default=1, help='random seed (default: 1):s')
