...
from utils.sampling import mnist_iid, mnist_noniid, cifar_iid, mnist_iid_even
def load_data(args):
    ...
    if args.dataset == 'mnist':
        ...
        if args.iid:
            ...
            dict_users, dataset_train_real = mnist_iid_even(dataset_train, args.num_users)
        else:
        ...
        if args.iid:
            ...
            exit('Error: setting not considered for Cifar10')
    else:
